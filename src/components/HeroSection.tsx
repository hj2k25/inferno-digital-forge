      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-xl md:text-2xl text-volcanic-600 mb-8 leading-relaxed">
            Tritt ein in die Flammen, kaufe das Unvergängliche!
          </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <Button 
            size="lg" 
            className="lava-button text-white text-lg px-8 py-6 rounded-lg font-semibold shadow-2xl transform transition-all duration-300 hover:scale-105"
          >
